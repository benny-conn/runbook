...
import (
	...
	ibkrprovider "github.com/benny-conn/runbook/providers/ibkr"
	...
	tradovateprovider "github.com/benny-conn/runbook/providers/tradovate"
...
func main() {
	...
	log.Printf("starting live trading | provider=%s strategy=%s symbols=%s capital=%.2f",
